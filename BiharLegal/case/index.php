...
<?php 
$navbarcasenav = "SELECT * from `formreg` Order By `formreg_id` DESC";
...
<div class="container">
 <div class="row">
 <div class="col-lg-6 w3-card" style="border:0.5px solid pink;">
 ...
 <div class="jumbotron w3-card-4 table table-bordered table-dark" style="border:1px solid black;">
  ...
  <pre> #Case submitted By:<button class="btn btn-info"><?php echo $row["formreg_username"];?></button> </pre>
 ...
 <div class="col-lg-6"><object width="700" height="560" data="../pdf/<?php echo $row["formreg_file"];?>" style="border:10px solid black;" class="w3-card-4"></object></div>
 </div> 
 
  
 
                <!-- Go to www.addthis.com/dashboard to customize your tools -->
                <div class="addthis_inline_follow_toolbox_d03i"></div>
