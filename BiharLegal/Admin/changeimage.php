...
$account = "select * from admin WHERE admin_count = '$count'";
...
<?php 
$picupdate = "UPDATE `admin` SET `admin_image`='$snehi_file_img_name' WHERE admin_count= '$count'";
...
$_SESSION["apimage"]=$snehi_file_img_name;
?> 
