...
<div class="card pd-20 pd-sm-40">
 ...
 <?php 
$sqlscript = "SELECT * FROM account";
$result2 = $conn->query($sqlscript);
...
if ($result2->num_rows > 0) {
    ...
    <tr>
                  ...
                  <td style="color:red;"><i class="fa fa-minus-circle" aria-hidden="true" style="color:red;"></i> &nbsp;Delete</td>
   </tr> 
<?php
  }
} else {
